...
/*
 *
 * From "iPhone 3D Programming, O'Reilly Publishers"
 * Appendix A
 *
 */
#include <cmath>
...
struct Vector2 {
    ...
    Vector2 Lerp(double t, const Vector2& v) const
    {
...
struct Vector3 {
    ...
    Vector3 Lerp(double t, const Vector3& v) const
    {
...
struct Vector4 {
    ...
    Vector4 Lerp(double t, const Vector4& v) const
    {
